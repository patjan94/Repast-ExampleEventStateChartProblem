@ECHO OFF
TITLE ExampleEventStateChartProblem
...
CD ExampleEventStateChartProblem

REM Start the Model
START javaw -XX:+IgnoreUnrecognizedVMOptions --add-modules=ALL-SYSTEM --add-exports=java.base/jdk.internal.ref=ALL-UNNAMED -cp %CP% repast.simphony.runtime.RepastMain ./ExampleEventStateChartProblem.rs
